...
('0-1', 'Promag', 'kapsul', 'bebas', 2000.00, 8),
('O-2', 'Mixagrip', 'Strip', 'Bebas', 2000.00, 98),
('O-3', 'Oskadon', 'Pusing', 'Bebas', 1500.00, 100),
('O-4', 'Bodrex', 'Pil', 'Bebas', 30000.00, 95),
('O-5', 'Geliga Balsem', 'Pack', 'Bebas', 50000.00, 88);
...
(0, '2024-01-04', 1502000.00, 0.00, 0.00, 1, 'ID-1');
...
('ID-2', 'Ahmad', 'P', 'semarang', '0000', 'pasien', 'pasien', 'Pasien'),
